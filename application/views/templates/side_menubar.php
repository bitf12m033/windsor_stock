    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($user_permission): ?>
            ...
            <li class="treeview" id="mainProductNav">
              ...
              <ul class="treeview-menu">
                ...
                <?php if(in_array('viewProduct', $user_permission) && !$this->session->userdata('is_admin')): ?>
                  <li id="otherStoresProductNav"><a href="<?php echo base_url('products/other_stores') ?>"><i class="fa fa-circle-o"></i> Other Stores Products</a></li>
                <?php endif; ?>
                <?php if(in_array('viewProduct', $user_permission)): ?>
                  <li id="soldProductNav"><a href="<?php echo base_url('products/sold_products') ?>"><i class="fa fa-circle-o"></i> Sold Products</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
          ...
          <?php endif; ?>
          <?php if(in_array('createRepairJob', $user_permission) || in_array('updateRepairJob', $user_permission) || in_array('viewRepairJob', $user_permission) || in_array('deleteRepairJob', $user_permission)): ?>
            <li id="repairJobNav">
              <a href="<?php echo base_url('repairJobs/') ?>">
                <i class="fa fa-wrench"></i> <span>Repair Jobs</span>
              </a>
            </li>
          <?php endif; ?>
