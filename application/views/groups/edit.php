                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Service</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createService" <?php if($serialize_permission) {
                          if(in_array('createService', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateService" <?php if($serialize_permission) {
                          if(in_array('updateService', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewService" <?php if($serialize_permission) {
                          if(in_array('viewService', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteService" <?php if($serialize_permission) {
                          if(in_array('deleteService', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Repair Jobs</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createRepairJob" <?php if($serialize_permission) {
                          if(in_array('createRepairJob', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateRepairJob" <?php if($serialize_permission) {
                          if(in_array('updateRepairJob', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewRepairJob" <?php if($serialize_permission) {
                          if(in_array('viewRepairJob', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteRepairJob" <?php if($serialize_permission) {
                          if(in_array('deleteRepairJob', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Stores</td>
