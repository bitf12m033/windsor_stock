	...
	*/
	public function fetchOrdersData()
	{
		...
		if ($this->session->userdata('is_admin')) {
			...
			$data = $this->model_orders->getOrdersDataByStore($store_id);
		}
			      ...
			      <div class="col-xs-12 table-responsive">
			        <table class="table table-striped">
			         ...
			         foreach ($orders_items as $k => $v) {
                                ...
                                // Check if $product_data is null or empty
                                if ($product_data === null || empty($product_data)) {
                                    // Skip the current iteration and proceed to the next one
                                    continue;
                                }
                                
                                // If $product_data is not null and not empty, continue with rendering the table row
                                $html .= '<tr>
